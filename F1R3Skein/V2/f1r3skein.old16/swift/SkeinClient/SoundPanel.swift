        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(model.canChangeScale
                    ...
                    .font(.caption2)
                    // Name the type on both branches: `.secondary` is a
                    // HierarchicalShapeStyle and `.orange` is a Color, so the
                    // ternary has no common type without it.
                    .foregroundStyle(model.canChangeScale ? Color.secondary : Color.orange)
